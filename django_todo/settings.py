...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-u*jj0$wvnr)rr=341u=u)zj#j&n1b(rjuyepo+o-%ysl0mf%-4')
...
INSTALLED_APPS = [
    ...
    'todo'  # name of your own apps for Django to look for
]
